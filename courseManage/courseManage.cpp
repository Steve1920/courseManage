...
BEGIN_MESSAGE_MAP(CcourseManageApp, CWinApp)
...
CcourseManageApp::CcourseManageApp()
{
	// 支持重新启动管理器
...
// 唯一的一个 CcourseManageApp 对象

CcourseManageApp theApp;


// CcourseManageApp 初始化

BOOL CcourseManageApp::InitInstance()
{
